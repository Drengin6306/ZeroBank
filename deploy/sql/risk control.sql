...
(
    ...
    limit_type   tinyint        NOT NULL, # 2:日转账限额 3:单笔转账限额 4:日提现限额 5:单笔提现限额
    amount       DECIMAL(15, 2) NOT NULL,
    updated_at   TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    UNIQUE KEY unique_account_limit (account_type, limit_type)
);

INSERT INTO limit_amount (account_type, limit_type, amount)
VALUES
    -- 个人账户 0
    (0, 2, 500000.00),  -- 个人 日转账限额
    (0, 3, 100000.00),  -- 个人 单笔转账限额
    (0, 4, 100000.00),  -- 个人 日提现限额
    (0, 5, 20000.00),   -- 个人 单笔提现限额

    -- 企业账户 1
    (1, 2, 5000000.00), -- 企业 日转账限额
    (1, 3, 500000.00),  -- 企业 单笔转账限额
    (1, 4, 500000.00),  -- 企业 日提现限额
    (1, 5, 100000.00); -- 企业 单笔提现限额
