...
import (
	...
	"github.com/Drengin6306/ZeroBank/service/transaction/rpc/internal/server"
...
var configFile = flag.String("f", "etc/transaction.yaml", "the config file")
...
func main() {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		proto.RegisterTransactionServer(grpcServer, server.NewTransactionServer(ctx))
